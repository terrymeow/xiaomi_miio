...
ATTR_WATER_TANK_DETACHED_JSQS = "tank_filed"
...
BINARY_SENSOR_TYPES = (
    ...
    XiaomiMiioBinarySensorDescription(
        key=ATTR_WATER_TANK_DETACHED_JSQS,
        name="Water Tank",
        icon="mdi:car-coolant-level",
        device_class=BinarySensorDeviceClass.CONNECTIVITY,
        value=lambda value: not value,
...
HUMIDIFIER_JSQS_BINARY_SENSORS = (
    ATTR_WATER_SHORTAGE_FAULT,
    ATTR_WATER_TANK_DETACHED_JSQS,
)
